...
export function AuthForm({ mode }: AuthFormProps) {
  ...
  const formValid = isLogin
    ...
    : isSignupFormValid(fullName, username, email, password, confirmPassword) && termsAccepted;
  ...
  async function handleEmailAuth(e: React.FormEvent) {
    ...
    try {
      if (isLogin) {
        ...
        // Signup: use Supabase built-in email verification
        ...
        // Supabase sends its own verification email automatically.
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "0" }}>
                    <label style={{ display: "flex", alignItems: "flex-start", gap: "10px", cursor: loading ? "not-allowed" : "pointer" }}>
                      ...
                      <span style={{ fontSize: "13px", color: "var(--muted)", lineHeight: 1.55, fontFamily: "var(--font-sans)" }}>
                        I agree to the{" "}
                        <a href="/terms" target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()} style={{ color: "#FF7A1A", textDecoration: "underline" }}>
                          Terms of Service
                        </a>
                        {", "}
                        <a href="/privacy" target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()} style={{ color: "#FF7A1A", textDecoration: "underline" }}>
                          Privacy Policy
                        </a>
                        {", and "}
                        <a href="/acceptable-use" target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()} style={{ color: "#FF7A1A", textDecoration: "underline" }}>
